...
public class DateRange implements Serializable{
	...
	/**
	 * creates a new DateRange where the start and end dates are set to the moment
	 * of creation
	 */
	public DateRange(){
	...
	void setEndDate(Date endDate){
		...
		// default to new Date()
		this.endDate = endDate == null ? startDate == null ? new Date()
	...
	void setStartDate(Date startDate){
		...
		// default to new Date()
		this.startDate =
				startDate == null ? new Date() : (Date) startDate.clone();
	}
