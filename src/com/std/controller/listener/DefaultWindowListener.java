...
public class DefaultWindowListener implements WindowListener{
	...
	/**
	 * This is an internal class that is a thread that ensures that the program is
	 * closed correctly
	 *
	 * @author xxx
	 */
	...
	/**
	 * This occurs when the user has attempted to dispose of the view. If changes
	 * have been made to the model, the user will be prompted with dialog
