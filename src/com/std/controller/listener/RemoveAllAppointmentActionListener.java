...
/**
 * This is the listener listening to the remove all appointment button If the
 * button is pressed the user will be promted if they are sure they would like
 * to delete the appointment, if it is a recurring appointment then the user
 * will be promted if they would like to remove all of the recurring
 * appointments
 *
 * @author xxx
 */
...
public class RemoveAllAppointmentActionListener implements ActionListener{
	 ...
	 * Appointment is selected then the user is prompted if they are sure they
	 * would like to delete the appointment, if it is a recurring appointment then
	 * the user will be prompted if they would like to remove all of the recurring
	 * appointments
	 *
