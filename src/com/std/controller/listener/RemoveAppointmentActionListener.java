...
/**
 * This is the listener listening to the remove appointment button If the button
 * is pressed the user will be promted if they are sure they would like to
 * delete the appointment, if it is a recurring appointment then the user will
 * be promted if they would like to remove all of the recurring appointments
 *
 * @author xxx
 */
...
public class RemoveAppointmentActionListener implements ActionListener{
	...
	/**
	 * This occurs when the user has clicked the remove button, if a Appointment is
	 * selected then the user is prompted if they are sure they would like to
	 * delete the appointment, if it is a recurring appointment then the user will
	 * be prompted if they would like to remove all of the recurring appointments
	 *
	...
	public void actionPerformed(ActionEvent e){
		...
		if(ref != null){
            ...
            controller.getModel().removeAppointment(ref);
		}
		else{
