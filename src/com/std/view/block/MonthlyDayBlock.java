...
/**
 * This is the day representation in side of a week, its job is to hold the
 * RefreenceAppointments in order to display them
 *
 * @author xxx
 */
...
public class MonthlyDayBlock extends JToggleButton implements DayBlock{
	 ...
	 * AppointmentReadViews
	 */
	private MouseListener appointmentListener;

	/**
	 * This is the constructor, it sets up the center panel and the scrollPane that
	 * the center panel goes into, it also sets up the date from the parameter d
	 *
	...
	/**
	 * This method updates the panel with new information from the model it takes
	 * as parameter the neccesary information to update
	 *
