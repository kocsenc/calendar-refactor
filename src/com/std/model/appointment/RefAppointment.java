...
/**
 * A RefAppointment is an instantiated form of an Appointment.  It stores the
 * start date, and the parent AppointmentTemplate from which it will draw data
 * such as the appointment's description, title, etc. This was done so that
 * recurring appointments could be implemented. To make a full appointment, one
...
public class RefAppointment extends java.util.Observable
	...
	/**
	 * Sets the appointment start date, validates the input, and marks Observable
	 * as changed if any changes have been made.
	 *
	...
	/**
	 * Sets the appointment start date, and notifies any Observers if any changes
	 * have been made.
	 *
	...
	/**
	 * Sets the appointment end date, and notifies any Observers if any changes
	 * have been made.
	 *
