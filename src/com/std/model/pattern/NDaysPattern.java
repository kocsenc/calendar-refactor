...
/**
 * This class is the representation of a pattern that would exist every N number
 * of days. If the user would like an appointment to exist over a periodic
 * number of days, then this is the class that would deal with it
 *
 * @author xxx
 */
public class NDaysPattern extends RecurrencePattern{
	...
	/**
	 * passes DateRange to constructor in super throws IllegalArgumentException if
	 * nDays is less than 1 sets n to nDays
	 *
