...
/**
 * This is the abstract class Recurrence Pattern It is a template for the
 * patterns that recurring appointments should take. For example if a user would
 * want to have an appointment happen every Tuesday and Thursday, one could
 * extend this class into a class that returns the dates in which that
 * appointment should exist
 */
public abstract class RecurrencePattern implements Serializable{

	/**
	 * This is the span of time that the appointment can exist on.
	 */
	private DateRange occuranceRange;


	/**
	 * This is the constructor it takes in the date range and sets it as the
	 * occuranceRange
	 *
	 ...
	 */
	protected abstract void readObject(ObjectInputStream o)
	 ...
	 * @throws IOException an I/O exception of some sort has occurred
	 */
	protected abstract void writeObject(ObjectOutputStream i)
			throws IOException;
